...
namespace LoadingProgram
{
    class Program
    {
        ...
        {
            //Hydrostatics table for some try
            ...
            //Input the ship displasement
            double shipDispl = 13225;

            //Find the string index of the nearest displacement which is smaller than given one
            int m = -1, n = 2;
            ...
            // Write the indexex of nearest displacement elements
            // Console.WriteLine($"D1 = {sh[m, n]}\tD2 = {sh[(m + 1), n]}");

            //Find the draught of the ship using INTERPOLATON 
